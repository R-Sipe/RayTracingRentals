namespace RayTracingRental.Data.Migrations
{
    ...
    public partial class PoggMigration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        RentalStoreId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.RentalOrderId)
                .ForeignKey("dbo.RentalStore", t => t.RentalStoreId, cascadeDelete: true)
                .Index(t => t.RentalStoreId);
